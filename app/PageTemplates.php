    ...
    */
    ...
    private function standard()
    {
        ...
        $this->crud->addField([
                        ...
                        'options' => ['secure/myaccount' => 'My Account', 'basket' => 'Basket', 'secure/checkout' => 'Checkout', 'donations' => 'Donations', 'giftvouchers' => 'Gift Vouchers', 'memberships' => 'Memberships', 'merchandise' => 'Merchandise'],
                        'allows_null' => true,
                    ]);
        $this->crud->addField([
    ...
    private function simple()
    {
        ...
        $this->crud->addField([
                        ...
                        'tab' => 'iFrame',
                        'type' => 'select_from_array',
                        'options' => ['secure/checkout' => 'Checkout', 'donations' => 'Donations', 'giftvouchers' => 'Gift Vouchers', 'memberships' => 'Memberships', 'merchandise' => 'Merchandise'],
                        'allows_null' => true,
                    ]);
        $this->crud->addField([
                        'name' => 'iframe_parameters',
