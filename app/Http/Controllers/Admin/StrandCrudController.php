...
use App\Http\Requests\StrandRequest as StoreRequest;
use App\Http\Requests\StrandRequest as UpdateRequest;

class StrandCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Strand');
