<?php
  ...
  class Film extends Model
  {
      ...
      */
      ...
      protected $fillable = ['title','subtitle','slug','certificate','thumb','description','short_description','runtime','trailer_duration','custom_coming_soon','buy_url','director','starring','country','language','f_rating','year','association','format','tickets','alt_language_title','free','audio_description'];
      // protected $hidden = [];
      // protected $dates = [];
