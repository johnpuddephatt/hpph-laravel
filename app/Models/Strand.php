...
class Strand extends Model
{
    ...
    */
    ...
    public function newestFilms($film_id) {
      return $this->films()->hasFutureScreenings()->where('film_id','!=',$film_id)->with(['screenings','strands','venue'])->orderBy('created_at')->take(3)->get();
    }
    /*
    |--------------------------------------------------------------------------
    | RELATIONS
