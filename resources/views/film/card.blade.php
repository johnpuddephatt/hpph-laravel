<a class="film-card" href="/film/{{ $film->slug }}">
  ...
  <div class="film-card--image">
    @include('utils.cloudinary', [ 'alt' => "Image for " . $film->title, 'img' => $film->thumb, 'width' => "480", 'height' => "270", 'quality' => "65", 'sizes' => "(min-width: 900px) 30vw, (min-width: 600px) 50vw, 25vw", 'class' => 'fade-image-onload' ])
  </div>
