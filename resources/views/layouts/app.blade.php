...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    @if(config('app.analytics')) @include('analytics') @endif
    ...
    <meta
      name="description"
      content="@yield('description', config('app.description'))"
    />
    ...
    <script
      ...
      data-components="spektrix-login-status,spektrix-basket-summary,spektrix-donate"
      async
    ></script>
    @stack('scripts')
  </head>
