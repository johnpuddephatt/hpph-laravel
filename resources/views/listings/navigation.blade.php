  ...
  <div class="listings-navigation--inner">
    ...
    @if($type == 'weekly')
      <div class="weekly-screenings--navigation">
          ...
          @else
            <button class="weekly-screenings--navigation--trigger button__ghost">{{ Carbon\Carbon::parse($week_commencing)->format('D jS M') }} &ndash; {{ Carbon\Carbon::parse($week_ending)->format('D jS M') }}</button>
          @endif
